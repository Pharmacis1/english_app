    ...
    function renderStoryHub() {
        ...
        if (chaptersContainer && chapters.length > 0) {
            ...
            const detNamesMap = {
                ...
                gordon: { name: "Captain Gordon", icon: "fa-anchor", color: "#38bdf8" }
            };
    ...
    function openStoryChapterReader(rawChapter) {
        ...
        if (heroesStrip && chapter.involvedHeroes) {
            const detCharMeta = {
                ...
                gordon: { name: "Captain Gordon", avatar: "fa-anchor", color: "#38bdf8", faceImage: "images/characters_orig/valerius_orig.jpg" }
            };

...
function generateHeroWords(heroId) {
    const wordLists = {
        ...
        ignis: [
            ...
            ["Orange", "/ˈɒr.ɪndʒ/", "Оранжевый", "Orange fire spark."],
        ...
        frostina: [
            ...
            ["Cold", "/kəʊld/", "Холодный", "It is very cold."],
            ["Warm", "/wɔːm/", "Тёплый", "A warm sunny day."],
            ["Hot", "/hɒt/", "Жаркий", "Hot summer weather."],
        ...
        thorin: [
            ...
            ["Door", "/dɔːr/", "Дверь", "Heavy oak door."],
            ["Window", "/ˈwɪn.dəʊ/", "Окно", "Glass window."],
            ["Desk", "/desk/", "Письменный стол", "Study desk."],
            ["Chair", "/tʃeər/", "Стул", "Sit on a chair."],
            ["Table", "/ˈteɪ.bəl/", "Стол", "Big dining table."],
            ["Bed", "/bed/", "Кровать", "A soft comfortable bed."],
            ["Box", "/bɒks/", "Ящик / Коробка", "Heavy iron box."],
            ...
            ["Light", "/laɪt/", "Лёгкий (по весу)", "Light aluminum shield."],
            ["Strong", "/strɒŋ/", "Сильный / Прочный", "Strong berserker smith."],
            ["Weak", "/wiːk/", "Слабый", "Weak old fence."],
            ["Hard", "/hɑːd/", "Твёрдый / Трудный", "Hard forged steel."],
            ["Soft", "/sɒft/", "Мягкий", "Soft wool pillow."],
            ["Clean", "/kliːn/", "Чистый", "Clean tidy workshop."],
            ["Dirty", "/ˈdɜː.ti/", "Грязный", "Dirty coal hands."],
            ["Full", "/fʊl/", "Полный", "Full chest of gold."],
            ...
            ["Make", "/meɪk/", "Создавать", "Make heavy shields."],
            ["Fix", "/fɪks/", "Чинить", "Fix broken armor."],
            ["Break", "/breɪk/", "Ломать", "Break hard stone."],
            ["Cut", "/kʌt/", "Резать", "Cut hard wood."],
            ["Open", "/ˈəʊ.pən/", "Открывать", "Open the iron gate."],
            ["Close", "/kləʊz/", "Закрывать", "Close the heavy door."],
            ["Lock", "/lɒk/", "Замок / Запирать", "Lock the box."],
            ["Key", "/kiː/", "Ключ", "Iron key."],
        ...
        selene: [
            ...
            ["Run", "/rʌn/", "Бегать", "Run fast in shadows."],
            ...
            ["Strong", "/strɒŋ/", "Сильный", "Strong muscles."],
            ...
            ["Night", "/naɪt/", "Ночь", "Hunter of the night."],
        ...
        oberon: [
            ...
            ["Wood", "/wʊd/", "Лес / Роща", "Walk in the woods."],
            ...
            ["Sky", "/skaɪ/", "Небо", "Clear blue sky."],
            ["Sun", "/sʌn/", "Солнце", "Warm golden sun."],
            ["Moon", "/muːn/", "Луна", "Full white moon."],
            ["Star", "/stɑːr/", "Звезда", "Shining night star."],
            ["Air", "/eər/", "Воздух", "Fresh clean air."],
            ["Wind", "/wɪnd/", "Ветер", "Gentle forest wind."],
            ["Rain", "/reɪn/", "Дождь", "Warm spring rain."],
            ["Snow", "/snəʊ/", "Снег", "White mountain snow."],
            ...
            ["Is", "/ɪz/", "Есть (Present Continuous)", "The sun is shining."],
            ["Are", "/ɑːr/", "Есть (мн.ч. Continuous)", "Birds are singing."],
        ...
        freya: [
            ...
            ["Travel", "/ˈtræv.əl/", "Путешествовать", "Travel around the world."],
            ...
            ["Yesterday", "/ˈjes.tə.deɪ/", "Вчера", "Did you travel yesterday?"],
            ...
            ["Find", "/faɪnd/", "Находить", "Find the way."],
            ["Found", "/faʊnd/", "Нашёл", "Found a golden coin."],
            ["Show", "/ʃəʊ/", "Показывать", "Show your bravery."],
            ...
            ["Help", "/help/", "Помогать", "Help warriors."],
        ...
        eldrin: [
            ...
            ["Fact", "/fækt/", "Факт", "An important fact."],
            ...
            ["Second", "/ˈsek.ənd/", "Второй", "The second hero."],
            ...
            ["Part", "/pɑːt/", "Часть", "Part of the squad."],
            ["Piece", "/piːs/", "Кусок", "A piece of paper."],
            ["Group", "/ɡruːp/", "Группа", "A hero group."],
            ...
            ["Side", "/saɪd/", "Сторона", "On your side."],
            ["Top", "/tɒp/", "Вершина", "Top level."],
            ["Bottom", "/ˈbɒt.əm/", "Низ", "Bottom line."],
            ["Thing", "/θɪŋ/", "Вещь / Предмет", "An important thing."],

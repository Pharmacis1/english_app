...
function generateHeroWords(heroId) {
    const wordLists = {
        ...
        ignis: [
            ...
            ["A lamp", "/a lamp/", "A lamp", "A1 core word: A lamp."],
            ["About", "/about/", "About", "A1 core word: About."]
        ],
        frostina: [
            ...
            ["Across", "/across/", "Across", "A1 core word: Across."],
            ["Action", "/action/", "Action", "A1 core word: Action."],
            ["Activity", "/activity/", "Activity", "A1 core word: Activity."]
        ],
        zephyr: [
            ...
            ["Bank", "/bæŋk/", "Банк", "Bank on the corner."],
            ...
            ["Add", "/add/", "Add", "A1 core word: Add."],
            ["Address", "/address/", "Address", "A1 core word: Address."]
        ],
        thorin: [
            ...
            ["Lamp", "/læmp/", "Лампа", "A bright desk lamp."],
            ...
            ["Adj", "/adj/", "Adj", "A1 core word: Adj."],
            ["Advice", "/advice/", "Advice", "A1 core word: Advice."],
            ["Afraid", "/afraid/", "Afraid", "A1 core word: Afraid."],
            ["After", "/after/", "After", "A1 core word: After."],
            ["Again", "/again/", "Again", "A1 core word: Again."],
            ["Age", "/age/", "Age", "A1 core word: Age."],
            ["Agree", "/agree/", "Agree", "A1 core word: Agree."],
            ["Also", "/also/", "Also", "A1 core word: Also."],
            ["Amazing", "/amazing/", "Amazing", "A1 core word: Amazing."],
            ["And", "/and/", "And", "A1 core word: And."],
            ["Angry", "/angry/", "Angry", "A1 core word: Angry."],
            ["Any", "/any/", "Any", "A1 core word: Any."],
            ["Area", "/area/", "Area", "A1 core word: Area."],
            ["Around", "/around/", "Around", "A1 core word: Around."],
            ["Artist", "/artist/", "Artist", "A1 core word: Artist."],
            ["As", "/as/", "As", "A1 core word: As."],
            ["Away", "/away/", "Away", "A1 core word: Away."]
        ],
        selene: [
            ...
            ["Bad", "/bad/", "Bad", "A1 core word: Bad."],
            ["Ball", "/ball/", "Ball", "A1 core word: Ball."],
            ["Band", "/band/", "Band", "A1 core word: Band."],
            ["Bank money", "/bank money/", "Bank money", "A1 core word: Bank money."],
            ["Bath", "/bath/", "Bath", "A1 core word: Bath."],
            ["Beautiful", "/beautiful/", "Beautiful", "A1 core word: Beautiful."],
            ["Because", "/because/", "Because", "A1 core word: Because."],
            ["Before", "/before/", "Before", "A1 core word: Before."],
            ["Begin", "/begin/", "Begin", "A1 core word: Begin."],
            ["Believe", "/believe/", "Believe", "A1 core word: Believe."],
            ["Below", "/below/", "Below", "A1 core word: Below."]
        ],
        oberon: [
            ...
            ["Best", "/best/", "Best", "A1 core word: Best."],
            ["Better", "/better/", "Better", "A1 core word: Better."],
            ["Birthday", "/birthday/", "Birthday", "A1 core word: Birthday."],
            ["Blog", "/blog/", "Blog", "A1 core word: Blog."],
            ["Blonde", "/blonde/", "Blonde", "A1 core word: Blonde."],
            ["Boot", "/boot/", "Boot", "A1 core word: Boot."],
            ["Bored", "/bored/", "Bored", "A1 core word: Bored."],
            ["Boring", "/boring/", "Boring", "A1 core word: Boring."],
            ["Born", "/born/", "Born", "A1 core word: Born."],
            ["Business", "/business/", "Business", "A1 core word: Business."],
            ["Busy", "/busy/", "Busy", "A1 core word: Busy."],
            ["But", "/but/", "But", "A1 core word: But."],
            ["By", "/by/", "By", "A1 core word: By."],
            ["Bye", "/bye/", "Bye", "A1 core word: Bye."],
            ["Cafe", "/cafe/", "Cafe", "A1 core word: Cafe."],
            ["Capital", "/capital/", "Capital", "A1 core word: Capital."],
            ["Card", "/card/", "Card", "A1 core word: Card."],
            ["Career", "/career/", "Career", "A1 core word: Career."],
            ["Carry", "/carry/", "Carry", "A1 core word: Carry."],
        ...
        freya: [
            ...
            ["Cent", "/cent/", "Cent", "A1 core word: Cent."],
            ["Centre", "/centre/", "Centre", "A1 core word: Centre."],
            ["Chart", "/chart/", "Chart", "A1 core word: Chart."],
            ["Check", "/check/", "Check", "A1 core word: Check."],
            ["Choose", "/choose/", "Choose", "A1 core word: Choose."],
            ["Cinema", "/cinema/", "Cinema", "A1 core word: Cinema."],
            ["Class", "/class/", "Class", "A1 core word: Class."],
            ["Classroom", "/classroom/", "Classroom", "A1 core word: Classroom."],
            ["College", "/college/", "College", "A1 core word: College."],
            ["Colour", "/colour/", "Colour", "A1 core word: Colour."],
        ...
        eldrin: [
            ...
            ["Correct", "/correct/", "Correct", "A1 core word: Correct."],
            ["Correspond", "/correspond/", "Correspond", "A1 core word: Correspond."],
            ["Create", "/create/", "Create", "A1 core word: Create."],
            ["Culture", "/culture/", "Culture", "A1 core word: Culture."],
            ["Customer", "/customer/", "Customer", "A1 core word: Customer."],
            ["Dad", "/dad/", "Dad", "A1 core word: Dad."],
            ["Dancer", "/dancer/", "Dancer", "A1 core word: Dancer."],
            ["Dancing", "/dancing/", "Dancing", "A1 core word: Dancing."],
            ["Dangerous", "/dangerous/", "Dangerous", "A1 core word: Dangerous."],
            ["Date", "/date/", "Date", "A1 core word: Date."],
            ["Dear", "/dear/", "Dear", "A1 core word: Dear."],
            ["Decide", "/decide/", "Decide", "A1 core word: Decide."],
            ["Delicious", "/delicious/", "Delicious", "A1 core word: Delicious."],
            ["Describe", "/describe/", "Describe", "A1 core word: Describe."],
            ["Description", "/description/", "Description", "A1 core word: Description."],
            ["Design", "/design/", "Design", "A1 core word: Design."],
            ["Det", "/det/", "Det", "A1 core word: Det."],
            ["Detail", "/detail/", "Detail", "A1 core word: Detail."],
            ["Dialogue", "/dialogue/", "Dialogue", "A1 core word: Dialogue."],
            ["Dictionary", "/dictionary/", "Dictionary", "A1 core word: Dictionary."],
            ["Die", "/die/", "Die", "A1 core word: Die."]
        ],
    };
